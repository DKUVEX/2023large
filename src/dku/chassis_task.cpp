...
void chassis_task_fn(void* param) {
    ...
    while (true) {
        ...
        chassis_move.motor_chassis[1].motor_status->move( forward + turn - lr);
        chassis_move.motor_chassis[2].motor_status->move(-forward + turn + lr);
        chassis_move.motor_chassis[3].motor_status->move(-forward + turn - lr);
