...
pros::GPS gps_left(SENSOR_GPS_LEFT_PORT, SENSOR_GPS_LEFT_INITIAL_X, SENSOR_GPS_LEFT_INITIAL_Y, 
                    SENSOR_GPS_LEFT_INITIAL_HEADING, SENSOR_GPS_LEFT_OFFSET_X, SENSOR_GPS_LEFT_OFFSET_Y);
pros::GPS gps_right(SENSOR_GPS_RIGHT_PORT, SENSOR_GPS_RIGHT_INITIAL_X, SENSOR_GPS_RIGHT_INITIAL_Y, 
                    SENSOR_GPS_RIGHT_INITIAL_HEADING, SENSOR_GPS_RIGHT_OFFSET_X, SENSOR_GPS_RIGHT_OFFSET_Y);
...
static void sensor_init(sensor_data_t *sensor_fetch_init)
{
    sensor_fetch_init->gps_left_data.gps_pointer = &gps_left;
    sensor_fetch_init->gps_right_data.gps_pointer = &gps_right;
    gps_data_update(&sensor_fetch_init->gps_left_data);
    gps_data_update(&sensor_fetch_init->gps_right_data);
}
/**
...
void sensor_task_fn(void* param)
{
    ...
    while (true) {
        gps_data_update(&sensor_fetch.gps_left_data);
        gps_data_update(&sensor_fetch.gps_right_data);
        /*test code*/
